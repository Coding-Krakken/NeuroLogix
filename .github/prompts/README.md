...
| Prompt                     | Purpose                                          | When to Use                       |
| -------------------------- | ------------------------------------------------ | --------------------------------- |
| `domain-model.prompt.md`   | Create `.system-state/model/` domain entities    | New feature or domain modeling    |
...
| `api-contract.prompt.md`   | Define API schemas in `.system-state/contracts/` | New API endpoints or integrations |
...
| Prompt                                    | Purpose                                                                 | When to Use              |
| ----------------------------------------- | ----------------------------------------------------------------------- | ------------------------ |
| **`mode-selection.prompt.md`** ⭐         | Auto-select audit mode (FAST/STANDARD/THOROUGH) via deterministic rules | Starting framework audit |
...
| **`remediation-dispatch.prompt.md`** ⭐   | Dispatch remediation tasks automatically                                | After report generated   |
...
1. **`mode-selection.prompt.md`** — Guide Framework Auditor to auto-select mode (FAST/STANDARD/THOROUGH)
...
7. **`remediation-dispatch.prompt.md`** — Dispatch remediation tasks to Chief of Staff automatically
...
- Related prompt: ../category/related.prompt.md
...
1. `mode-selection.prompt.md` → Auto-select audit mode (FAST/STANDARD/THOROUGH)
...
- `mode-selection.prompt.md` ⭐ (auto-select audit mode)
...
- `remediation-dispatch.prompt.md` ⭐ (auto-dispatch fixes to Chief of Staff)
