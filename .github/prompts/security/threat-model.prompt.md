...
1. Client Browser ↔ <WEB_FRAMEWORK> Server (untrusted → semi-trusted)
2. <WEB_FRAMEWORK> Server ↔ <PAYMENT_PROVIDER> API (semi-trusted → trusted)

### Assets

1. Customer PII (name, email, address)
2. Payment data (handled by <PAYMENT_PROVIDER> only)
3. <PAYMENT_PROVIDER> API credentials
