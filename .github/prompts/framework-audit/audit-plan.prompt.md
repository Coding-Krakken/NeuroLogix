...
- Performance targets (from Issue #<WORK_ITEM_ID>)
...
gh issue list --limit 10 --json number,title,updatedAt,url
...
- Unclear performance targets → Use defaults from Issue #<WORK_ITEM_ID>
