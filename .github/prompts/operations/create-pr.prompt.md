...
```powershell
gh pr edit <pr-number> --add-reviewer "00-chief-of-staff,security-engineer,11-tech-lead"
...
- ✅ **G4: Build** — <WEB_FRAMEWORK> production build succeeded
...
- DNS fallback to <ROLLBACK_TARGET_PLATFORM>
- Rollback time: <5 minutes
- Data: No data loss (<PAYMENT_PROVIDER> is source of truth)
...
- [ ] Handoff comments posted with traceable URLs
...
URL: https://github.com/<ORGANIZATION_NAME>/<REPOSITORY_NAME>/pull/123
