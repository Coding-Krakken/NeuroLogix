...
8. PACKETS: .customer/ and .developer/ updated per change
...
via ADR in .developer/DECISIONS.md.
...
2. `code chat -m agent "Follow instructions in .github\\prompts\\review-pr.prompt.md."`
