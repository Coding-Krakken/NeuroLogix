...
| `11-tech-lead`               | Generating slice checklists from completed plan       |
...
| `99-quality-director`        | Generating quality gate summary from passing results  |
...
```
DISPATCH CHAIN: [chief-of-staff] → [frontend-engineer (Mini)] → [frontend-engineer (⚡ Sonnet, E5)] → [11-tech-lead]
```
