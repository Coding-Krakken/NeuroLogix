...
- [x] Contract testing framework — server contract baselines for site-registry (#109), mission-control (#113), capability-registry (#119), and policy-engine (#121); `npm run test:contracts:servers` CI gate active
