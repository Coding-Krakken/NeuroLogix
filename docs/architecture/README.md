...
This directory contains Architectural Decision Records for the NeuroLogix platform. ADRs document important architectural decisions, their rationale, and consequences.
